...
(function () {
  ...
  window.IWIcons = {
    ...
    wind: svg(["M12.8 19.6A2 2 0 1 0 14 16H2", "M17.5 8a2.5 2.5 0 1 1 1.8 4.2H2", "M9.8 4.4A2 2 0 1 1 11 8H2"]),
    rainbow: svg(["M22 17a10 10 0 0 0-20 0", "M6 17a6 6 0 0 1 12 0", "M10 17a2 2 0 0 1 4 0"]),
    menu: svg(["M3 6h18", "M3 12h18", "M3 18h18"]),
    x: svg(["M18 6 6 18", "m6 6 12 12"]),
    clock: multi([{ t: "circle", p: { cx: 12, cy: 12, r: 9 } }, { t: "path", p: { d: "M12 7v5l3 2" } }]),
    star: svg(["M12 3l2.6 5.6 6.1.7-4.5 4.1 1.2 6L12 16.9 6.6 19.4l1.2-6L3.3 9.3l6.1-.7L12 3Z"]),
  };
})();
